		...
		<div class="container-login1001">
			<div class="wrap-login100">
					...
					<span class="login100-form-title-1">
						<center>DELETE&nbsp;&nbsp;ITEM<center>
					</span>
				</div>
                            <div class="form-style-8"> 
           <form action="deleteitems.jsp?demo=<%=request.getParameter("demo")%>&dn=<%=request.getParameter("dn")%>&useri=<%=request.getParameter("useri")%>" method='post'>
             <label>DSR NO :</label>
